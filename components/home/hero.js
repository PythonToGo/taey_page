...
export default function Hero(){
    return (
        <>
            ...
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 dark:text-blue-300">THE WAY LIVE LIKE HEDGEHOG
            ...
            <div className="flex justify-center">
                ...
                <a className="inline-flex text-white bg-orange-400 border-0 py-2 px-6 focus:outline-none hover:bg-orange-400 rounded text-lg" id="/projects">Go to Project</a>
                </Link>
